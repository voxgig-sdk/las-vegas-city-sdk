...
// LasVegasCity SDK proxy feature
...
class LasVegasCityProxyFeature extends LasVegasCityBaseFeature
{
    ...
    public function init(LasVegasCityContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LasVegasCityContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

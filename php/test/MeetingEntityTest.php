...
class MeetingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LAS_VEGAS_CITY_TEST_MEETING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function meeting_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LAS_VEGAS_CITY_TEST_MEETING_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LAS_VEGAS_CITY_TEST_MEETING_ENTID"]);

...
// LasVegasCity SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LasVegasCitySDK::test)
...
{
    private const SDK_CLASS = 'LasVegasCitySDK';
    ...
    private const SDK_BASE = 'lasvegascity_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../lasvegascity_sdk.php';

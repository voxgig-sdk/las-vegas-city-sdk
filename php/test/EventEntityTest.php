...
class EventEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LASVEGASCITY_TEST_EVENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function event_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LASVEGASCITY_TEST_EVENT_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LASVEGASCITY_TEST_EVENT_ENTID"]);

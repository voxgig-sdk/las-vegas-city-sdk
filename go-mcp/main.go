// Command LasVegasCity-mcp is an MCP server exposing the LasVegasCity
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LasVegasCity_list  — list records of an entity
//	LasVegasCity_load  — load a single record of an entity
//

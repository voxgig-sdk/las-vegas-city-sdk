...
local EconomicDevelopmentEntity = {}
EconomicDevelopmentEntity.__index = EconomicDevelopmentEntity


function EconomicDevelopmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EconomicDevelopmentEntity)
  self._name = "economic_development"
  self._client = client
...
function EconomicDevelopmentEntity:get_name()
  return self._name
end


function EconomicDevelopmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EconomicDevelopmentEntity.new(self._client, opts)
end
...
function EconomicDevelopmentEntity:mark_deleted()
  self._deleted = true
end


function EconomicDevelopmentEntity:deleted()
  return true == self._deleted
end


function EconomicDevelopmentEntity:data_set(args)
  if args ~= nil then
...
function EconomicDevelopmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EconomicDevelopmentEntity:match_set(args)
  if args ~= nil then
...
function EconomicDevelopmentEntity:match_get()
...
function EconomicDevelopmentEntity:stream(action, args, callopts)
...
function EconomicDevelopmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EconomicDevelopmentEntity

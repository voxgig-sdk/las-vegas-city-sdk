...
(0, node_test_1.describe)('PermitEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'permit.' + op, live))
                return;
        }
        ...
        let permit_ref01_data = Object.values(setup.data.existing.permit)[0];
        // LIST
        const permit_ref01_ent = client.Permit();
        const permit_ref01_match = {};
        const permit_ref01_list = (await permit_ref01_ent.list(permit_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/permit/PermitTestData.json');
    ...
    let idmap = transform(['permit01', 'permit02', 'permit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PermitEntity.test.js.map
...
// LasVegasCity SDK EconomicDevelopment entity
...
class EconomicDevelopmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "economic_development";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EconomicDevelopmentEntity($this->_client, $opts);
    }

    /**
     * @param EconomicDevelopment|array $args EconomicDevelopment data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = LasVegasCityHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return EconomicDevelopment|array The current EconomicDevelopment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EconomicDevelopment fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = LasVegasCityHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of EconomicDevelopment fields).
     */
    ...
    /**
     * List EconomicDevelopment items matching the given filter.
     *
     * @param EconomicDevelopmentListMatch|array|null $reqmatch Match filter (any subset
     *   of EconomicDevelopment fields) as an assoc-array; EconomicDevelopmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EconomicDevelopment[]|array A list of EconomicDevelopment items as assoc-arrays at
     *   the SDK boundary; throws LasVegasCityError on failure (item-5 convention).
     */

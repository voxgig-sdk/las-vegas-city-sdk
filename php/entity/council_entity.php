...
// LasVegasCity SDK Council entity
...
class CouncilEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CouncilEntity($this->_client, $opts);
    }

    /**
     * @param Council|array $args Council data (assoc-array) to store.
     */
    ...
    /**
     * @return Council|array The current Council data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Council fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Council fields).
     */
    ...
    /**
     * List Council items matching the given filter.
     *
     * @param CouncilListMatch|array|null $reqmatch Match filter (any subset
     *   of Council fields) as an assoc-array; CouncilListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Council[]|array A list of Council items as assoc-arrays at

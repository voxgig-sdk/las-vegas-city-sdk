...
class ParkDirectTest extends TestCase
{
    public function test_direct_list_park(): void
    {
        $setup = park_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-park", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

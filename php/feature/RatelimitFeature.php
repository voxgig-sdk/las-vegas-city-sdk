...
// LasVegasCity SDK ratelimit feature
...
class LasVegasCityRatelimitFeature extends LasVegasCityBaseFeature
{
    ...
    private function _acquire(LasVegasCityContext $ctx): void
    {
    ...
    private function _track(LasVegasCityContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
class LasVegasCityRbacFeature extends LasVegasCityBaseFeature
{
    ...
    private function _required(LasVegasCityContext $ctx): ?string
    {
    ...
    private function _reject(LasVegasCityContext $ctx, string $required): void
    {
    ...
    private function _track(LasVegasCityContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
(0, node_test_1.describe)('PermitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-permit', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-permit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LAS_VEGAS_CITY_TEST_PERMIT_ENTID'];
...
//# sourceMappingURL=PermitDirect.test.js.map
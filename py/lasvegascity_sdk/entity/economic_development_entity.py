...
from lasvegascity_sdk.lasvegascity_types import (
    EconomicDevelopment,
...
class EconomicDevelopmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EconomicDevelopmentEntity(self._client, opts)
    ...
    def data_get(self) -> EconomicDevelopment:
    ...
    def match_get(self) -> EconomicDevelopment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EconomicDevelopment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EconomicDevelopment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

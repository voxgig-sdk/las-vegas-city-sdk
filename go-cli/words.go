...
func registerSDKWords(r *eng.Registry, client *sdk.LasVegasCitySDK) {
...
func runOp(client *sdk.LasVegasCitySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

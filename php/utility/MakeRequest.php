...
class LasVegasCityMakeRequest
{
    public static function call(LasVegasCityContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LasVegasCityResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LasVegasCityResponse($fetched);
        } else {

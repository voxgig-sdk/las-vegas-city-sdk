...
(0, node_test_1.describe)('CityInfoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'city_info.' + op, live))
                return;
        }
        ...
        let city_info_ref01_data = Object.values(setup.data.existing.city_info)[0];
        // LOAD
        const city_info_ref01_ent = client.CityInfo();
        const city_info_ref01_match_dt0 = {};
        const city_info_ref01_data_dt0 = (await city_info_ref01_ent.load(city_info_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != city_info_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/city_info/CityInfoTestData.json');
    ...
    let idmap = transform(['city_info01', 'city_info02', 'city_info03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LAS_VEGAS_CITY_TEST_CITY_INFO_ENTID'];
...
//# sourceMappingURL=CityInfoEntity.test.js.map
...
class PermitEntity
  ...
  # @return [Permit, Hash] the current Permit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Permit fields)
  def match_get
  ...
  #
  # @param reqmatch [PermitListMatch, Hash, nil] match filter (any subset of
  #   Permit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Permit>, Array] the matching Permit items; raises LasVegasCityError on failure

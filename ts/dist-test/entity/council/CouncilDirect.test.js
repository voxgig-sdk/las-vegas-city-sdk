...
(0, node_test_1.describe)('CouncilDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-council', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-council', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LAS_VEGAS_CITY_TEST_COUNCIL_ENTID'];
...
//# sourceMappingURL=CouncilDirect.test.js.map
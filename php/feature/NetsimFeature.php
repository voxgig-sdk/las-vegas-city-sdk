...
// LasVegasCity SDK netsim feature
...
class LasVegasCityNetsimFeature extends LasVegasCityBaseFeature
{
    ...
    private function _simulate(LasVegasCityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LasVegasCityContext $ctx, array $applied): void
    {
        $client = $this->client;

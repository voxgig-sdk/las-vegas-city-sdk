...
// LasVegasCity SDK idempotency feature
...
class LasVegasCityIdempotencyFeature extends LasVegasCityBaseFeature
{
    ...
    private function _mutating(LasVegasCityContext $ctx): bool
    {

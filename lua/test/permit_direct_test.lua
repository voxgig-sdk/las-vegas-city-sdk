...
describe("PermitDirect", function()
  it("should direct-list-permit", function()
    local setup = permit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-permit", setup.live and "live" or "unit")
...
function permit_direct_setup(mockres)

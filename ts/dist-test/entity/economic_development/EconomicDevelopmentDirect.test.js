...
(0, node_test_1.describe)('EconomicDevelopmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LasVegasCitySDK({
    ...
    (0, node_test_1.test)('direct-list-economic_development', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-economic_development', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LasVegasCitySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['LAS_VEGAS_CITY_TEST_ECONOMIC_DEVELOPMENT_ENTID'];
    ...
    const client = new __1.LasVegasCitySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EconomicDevelopmentDirect.test.js.map
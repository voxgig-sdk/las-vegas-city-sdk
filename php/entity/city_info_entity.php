...
// LasVegasCity SDK CityInfo entity
...
class CityInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CityInfoEntity($this->_client, $opts);
    }

    /**
     * @param CityInfo|array $args CityInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return CityInfo|array The current CityInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CityInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CityInfo fields).
     */
     ...
     *
     * @param CityInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CityInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CityInfo|array The loaded CityInfo as an assoc-array at the

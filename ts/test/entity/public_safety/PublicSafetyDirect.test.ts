...
describe('PublicSafetyDirect', async () => {
  ...
  test('direct-load-public_safety', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-public_safety', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LAS_VEGAS_CITY_TEST_PUBLIC_SAFETY_ENTID']

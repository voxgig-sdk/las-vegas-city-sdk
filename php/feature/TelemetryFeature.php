...
// LasVegasCity SDK telemetry feature
...
class LasVegasCityTelemetryFeature extends LasVegasCityBaseFeature
{
    ...
    private function _close(LasVegasCityContext $ctx, bool $ok): void
    {

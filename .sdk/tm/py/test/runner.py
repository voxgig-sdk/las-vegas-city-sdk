...
class LasVegasCityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LasVegasCityTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LasVegasCityTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LasVegasCityTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

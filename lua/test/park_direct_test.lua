...
describe("ParkDirect", function()
  it("should direct-list-park", function()
    local setup = park_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-park", setup.live and "live" or "unit")
...
function park_direct_setup(mockres)

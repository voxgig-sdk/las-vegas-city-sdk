...
// LasVegasCity SDK metrics feature
...
class LasVegasCityMetricsFeature extends LasVegasCityBaseFeature
{
    ...
    private function _record(LasVegasCityContext $ctx, bool $ok): void
    {

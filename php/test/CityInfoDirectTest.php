...
class CityInfoDirectTest extends TestCase
{
    public function test_direct_load_city_info(): void
    {
        $setup = city_info_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-city_info", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

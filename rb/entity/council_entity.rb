...
class CouncilEntity
  ...
  def make
    opts = @_entopts.dup
    CouncilEntity.new(@_client, opts)
  end
  ...
  # @return [Council, Hash] the current Council data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Council fields)
  def match_get
  ...
  #
  # @param reqmatch [CouncilListMatch, Hash, nil] match filter (any subset of
  #   Council fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Council>, Array] the matching Council items; raises LasVegasCityError on failure

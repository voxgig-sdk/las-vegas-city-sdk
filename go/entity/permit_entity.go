...
func NewPermitEntity(client *core.LasVegasCitySDK, entopts map[string]any) *PermitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PermitEntity) GetName() string { return e.name }
...
func (e *PermitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PermitEntity) Deleted() bool {
	return e.deleted
}


func (e *PermitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPermitEntity(e.client, opts)
}

func (e *PermitEntity) Data(args ...any) any {
...
func (e *PermitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Permit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PermitEntity) DataTyped(data ...Permit) Permit {
	if len(data) > 0 {
		return typedFrom[Permit](e.Data(asMap(data[0])))
	}
	return typedFrom[Permit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Permit (all fields
// optional at the wire level).
func (e *PermitEntity) MatchTyped(match ...Permit) Permit {
	if len(match) > 0 {
		return typedFrom[Permit](e.Match(asMap(match[0])))
	}
	return typedFrom[Permit](e.Match())
}
...
func (e *PermitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PermitEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PermitEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PermitListMatch and returns []Permit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PermitEntity) ListTyped(reqmatch PermitListMatch, ctrl map[string]any) ([]Permit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Permit](res), nil
}



func (e *PermitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PermitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PermitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PermitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

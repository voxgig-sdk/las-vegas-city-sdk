...
//     (\`new LasVegasCitySDK(...)\` / \`LasVegasCitySDK.test(...)\` become
//     \`LasVegasCitySDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'LasVegasCitySDK'
...
const TEST_SEED = {"entity":{"city_info":{"test01":{"id":"test01"}},"council":{"test01":{"id":"test01"}},"department":{"test01":{"id":"test01"}},"economic_development":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"job":{"test01":{"id":"test01"}},"meeting":{"test01":{"id":"test01"}},"new":{"test01":{"id":"test01"}},"park":{"test01":{"id":"test01"}},"permit":{"test01":{"id":"test01"}},"public_safety":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new LasVegasCitySDK(...)\` and any
// \`LasVegasCitySDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+LasVegasCitySDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/LasVegasCitySDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)

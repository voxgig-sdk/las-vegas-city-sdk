...
const testSeed = `map[string]any{"entity": map[string]any{"city_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "council": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "department": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "economic_development": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "job": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meeting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "new": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "park": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_safety": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

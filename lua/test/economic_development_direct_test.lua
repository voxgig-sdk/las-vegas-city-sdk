...
describe("EconomicDevelopmentDirect", function()
  it("should direct-list-economic_development", function()
    local setup = economic_development_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-economic_development", setup.live and "live" or "unit")
...
function economic_development_direct_setup(mockres)

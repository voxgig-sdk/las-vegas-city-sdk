...
from lasvegascity_sdk.core.helpers import get_ctx_prop, to_map
...
class LasVegasCityContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LasVegasCitySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LasVegasCityResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LasVegasCityResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LasVegasCityError(code, msg, self)

...
// LasVegasCity SDK utility: graphql
//
...
class LasVegasCityGraphql
{
    ...
    // equivalent.
    public static function body(LasVegasCityContext $ctx): mixed
    {
    ...
    public static function errors(LasVegasCityContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

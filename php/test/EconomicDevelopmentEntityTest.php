...
class EconomicDevelopmentEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->EconomicDevelopment(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->EconomicDevelopment(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LAS_VEGAS_CITY_TEST_ECONOMIC_DEVELOPMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $economic_development_ref01_list_result = $economic_development_ref01_ent->list($economic_development_ref01_match, null);
...
function economic_development_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LAS_VEGAS_CITY_TEST_ECONOMIC_DEVELOPMENT_ENTID");

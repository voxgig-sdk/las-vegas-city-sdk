...
describe("CouncilDirect", function()
  it("should direct-list-council", function()
    local setup = council_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-council", setup.live and "live" or "unit")
...
function council_direct_setup(mockres)

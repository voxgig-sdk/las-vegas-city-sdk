...
// LasVegasCity SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LasVegasCityOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LasVegasCityOmni::structfix($now, Struct::undef()))
                        !== json_encode(LasVegasCityOmni::structfix($val, Struct::undef()))) {

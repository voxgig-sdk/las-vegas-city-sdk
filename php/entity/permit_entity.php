...
// LasVegasCity SDK Permit entity
...
class PermitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PermitEntity($this->_client, $opts);
    }

    /**
     * @param Permit|array $args Permit data (assoc-array) to store.
     */
    ...
    /**
     * @return Permit|array The current Permit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Permit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Permit fields).
     */
    ...
    /**
     * List Permit items matching the given filter.
     *
     * @param PermitListMatch|array|null $reqmatch Match filter (any subset
     *   of Permit fields) as an assoc-array; PermitListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Permit[]|array A list of Permit items as assoc-arrays at

...
class LasVegasCityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LasVegasCityTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LasVegasCityTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LasVegasCityTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

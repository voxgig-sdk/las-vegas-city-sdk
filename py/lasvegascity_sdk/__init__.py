...
from lasvegascity_sdk.core.spec import LasVegasCitySpec
from lasvegascity_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from lasvegascity_sdk.utility import register

# Load features
from lasvegascity_sdk.feature.base_feature import LasVegasCityBaseFeature
from lasvegascity_sdk.features import _has_feature, _make_feature
...
class LasVegasCitySDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "LasVegasCitySDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LasVegasCitySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CityInfo(self, data=None) -> "CityInfoEntity":
        ...
        from lasvegascity_sdk.entity.city_info_entity import CityInfoEntity
    ...
    def Council(self, data=None) -> "CouncilEntity":
        ...
        from lasvegascity_sdk.entity.council_entity import CouncilEntity
    ...
    def Department(self, data=None) -> "DepartmentEntity":
        ...
        from lasvegascity_sdk.entity.department_entity import DepartmentEntity
    ...
    def EconomicDevelopment(self, data=None) -> "EconomicDevelopmentEntity":
        ...
        from lasvegascity_sdk.entity.economic_development_entity import EconomicDevelopmentEntity
    ...
    def Event(self, data=None) -> "EventEntity":
        ...
        from lasvegascity_sdk.entity.event_entity import EventEntity
        return EventEntity(self, data)


    def Job(self, data=None) -> "JobEntity":
        """Entity factory: client.Job().list() / client.Job().load({"id": ...})."""
        from lasvegascity_sdk.entity.job_entity import JobEntity
    ...
    def PublicSafety(self, data=None) -> "PublicSafetyEntity":
        ...
        from lasvegascity_sdk.entity.public_safety_entity import PublicSafetyEntity

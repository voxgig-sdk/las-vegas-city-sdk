...
// LasVegasCity SDK audit feature
...
class LasVegasCityAuditFeature extends LasVegasCityBaseFeature
{
    ...
    private function _emit(LasVegasCityContext $ctx, string $outcome): void
    {

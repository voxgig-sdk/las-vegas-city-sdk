...
class ParkEntity
  ...
  #
  # @param reqmatch [ParkListMatch, Hash, nil] match filter (any subset of
  #   Park fields); defaults to nil, treated as an empty match that lists all.

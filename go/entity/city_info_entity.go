...
func NewCityInfoEntity(client *core.LasVegasCitySDK, entopts map[string]any) *CityInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityInfoEntity) GetName() string { return e.name }
...
func (e *CityInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CityInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *CityInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCityInfoEntity(e.client, opts)
}

func (e *CityInfoEntity) Data(args ...any) any {
...
func (e *CityInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CityInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CityInfoEntity) DataTyped(data ...CityInfo) CityInfo {
	if len(data) > 0 {
		return typedFrom[CityInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[CityInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CityInfo (all fields
// optional at the wire level).
func (e *CityInfoEntity) MatchTyped(match ...CityInfo) CityInfo {
	if len(match) > 0 {
		return typedFrom[CityInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[CityInfo](e.Match())
}
...
func (e *CityInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CityInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CityInfoLoadMatch and returns an CityInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CityInfoEntity) LoadTyped(reqmatch CityInfoLoadMatch, ctrl map[string]any) (CityInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CityInfo{}, err
	}
	return typedFrom[CityInfo](res), nil
}



func (e *CityInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CityInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CityInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CityInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CityInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

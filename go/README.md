...
## Install
```bash
go get github.com/voxgig-sdk/las-vegas-city-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/las-vegas-city-sdk=../path/to/github.com/voxgig-sdk/las-vegas-city-sdk
```
...
```
github.com/voxgig-sdk/las-vegas-city-sdk/
...
The root package (`github.com/voxgig-sdk/las-vegas-city-sdk`) re-exports everything needed

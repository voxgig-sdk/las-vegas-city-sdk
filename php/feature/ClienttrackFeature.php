...
// LasVegasCity SDK clienttrack feature
...
class LasVegasCityClienttrackFeature extends LasVegasCityBaseFeature
{
    ...
    public function PostConstruct(LasVegasCityContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LasVegasCity-SDK';

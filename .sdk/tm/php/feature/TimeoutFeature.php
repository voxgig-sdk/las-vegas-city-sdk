...
// LasVegasCity SDK timeout feature
...
class LasVegasCityTimeoutFeature extends LasVegasCityBaseFeature
{
    ...
    private function _with_timeout(LasVegasCityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LasVegasCityContext $_ctx, float $ms): void
    {
        $client = $this->client;

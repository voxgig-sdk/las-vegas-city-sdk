...
class EventEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LAS_VEGAS_CITY_TEST_EVENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def event_basic_setup(extra)
  ...
  entid_env_raw = ENV["LAS_VEGAS_CITY_TEST_EVENT_ENTID"]

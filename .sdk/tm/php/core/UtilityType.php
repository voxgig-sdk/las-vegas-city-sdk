...
// LasVegasCity SDK utility type

class LasVegasCityUtility
{
    ...
    public static function copy(LasVegasCityUtility $src): LasVegasCityUtility
    {
        $u = new LasVegasCityUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

...
function runner.env_override(m)
  local live = runner.getenv("LASVEGASCITY_TEST_LIVE")
  local override = runner.getenv("LASVEGASCITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LASVEGASCITY_TEST_EXPLAIN")

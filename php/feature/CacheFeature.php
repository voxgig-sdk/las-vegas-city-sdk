...
// LasVegasCity SDK cache feature
...
class LasVegasCityCacheFeature extends LasVegasCityBaseFeature
{
    ...
    private function _through(LasVegasCityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

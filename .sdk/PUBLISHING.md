...
|---|---|---|
| `ts/` | @voxgig-sdk/las-vegas-city-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/las-vegas-city-sdk \
      --repository voxgig-sdk/las-vegas-city-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/las-vegas-city-sdk` shows it, and
`npm trust revoke @voxgig-sdk/las-vegas-city-sdk --id=<id>` removes it.

...
describe('ParkDirect', async () => {
  ...
  test('direct-list-park', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-park', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LAS_VEGAS_CITY_TEST_PARK_ENTID']

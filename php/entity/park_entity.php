...
class ParkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ParkEntity($this->_client, $opts);
    }

    /**
     * @param Park|array $args Park data (assoc-array) to store.
     */
    ...
    /**
     * @return Park|array The current Park data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Park fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Park fields).
     */
     ...
     *
     * @param ParkListMatch|array|null $reqmatch Match filter (any subset
     *   of Park fields) as an assoc-array; ParkListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Park[]|array A list of Park items as assoc-arrays at

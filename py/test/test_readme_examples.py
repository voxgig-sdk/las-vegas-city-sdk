# LasVegasCity SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LasVegasCitySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LasVegasCitySDK(...) and LasVegasCitySDK.test(...) become
#      LasVegasCitySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lasvegascity_sdk"
_SDK_CLASS = "LasVegasCitySDK"
...
_ENTITIES = {
    ...
    "EconomicDevelopment": "economic_development",
    "Event": "event",
    "Job": "job",
    "Meeting": "meeting",
    "New": "new",

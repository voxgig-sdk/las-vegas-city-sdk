...
#      offline in seeded test mode (LasVegasCitySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "LasVegasCity_sdk.rb")
  SDK_CLASS = "LasVegasCitySDK"

...
// LasVegasCity SDK utility: fetcher

class LasVegasCityFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LasVegasCitySDK/1.0)';
    ...
    public static function call(LasVegasCityContext $ctx, string $fullurl, array $fetchdef): array
    {

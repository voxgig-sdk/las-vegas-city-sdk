...
func NewPublicSafetyEntity(client *core.LasVegasCitySDK, entopts map[string]any) *PublicSafetyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicSafetyEntity) GetName() string { return e.name }
...
func (e *PublicSafetyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicSafetyEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicSafetyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicSafetyEntity(e.client, opts)
}

func (e *PublicSafetyEntity) Data(args ...any) any {
...
func (e *PublicSafetyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicSafety; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicSafetyEntity) DataTyped(data ...PublicSafety) PublicSafety {
	if len(data) > 0 {
		return typedFrom[PublicSafety](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicSafety](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicSafety (all fields
// optional at the wire level).
func (e *PublicSafetyEntity) MatchTyped(match ...PublicSafety) PublicSafety {
	if len(match) > 0 {
		return typedFrom[PublicSafety](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicSafety](e.Match())
}
...
func (e *PublicSafetyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicSafetyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicSafetyLoadMatch and returns an PublicSafety. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PublicSafetyEntity) LoadTyped(reqmatch PublicSafetyLoadMatch, ctrl map[string]any) (PublicSafety, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PublicSafety{}, err
	}
	return typedFrom[PublicSafety](res), nil
}



func (e *PublicSafetyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PublicSafetyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicSafetyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicSafetyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicSafetyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

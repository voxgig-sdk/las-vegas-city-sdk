...
describe('CityInfoDirect', async () => {
  ...
  test('direct-load-city_info', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-city_info', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LAS_VEGAS_CITY_TEST_CITY_INFO_ENTID']

...
func NewParkEntity(client *core.LasVegasCitySDK, entopts map[string]any) *ParkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParkEntity) GetName() string { return e.name }
...
func (e *ParkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParkEntity) Deleted() bool {
	return e.deleted
}


func (e *ParkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParkEntity(e.client, opts)
}

func (e *ParkEntity) Data(args ...any) any {
...
func (e *ParkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Park; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParkEntity) DataTyped(data ...Park) Park {
	if len(data) > 0 {
		return typedFrom[Park](e.Data(asMap(data[0])))
	}
	return typedFrom[Park](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Park (all fields
// optional at the wire level).
func (e *ParkEntity) MatchTyped(match ...Park) Park {
	if len(match) > 0 {
		return typedFrom[Park](e.Match(asMap(match[0])))
	}
	return typedFrom[Park](e.Match())
}
...
func (e *ParkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ParkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParkListMatch and returns []Park. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ParkEntity) ListTyped(reqmatch ParkListMatch, ctrl map[string]any) ([]Park, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Park](res), nil
}



func (e *ParkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

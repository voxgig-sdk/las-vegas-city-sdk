...
class PublicSafetyEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LAS_VEGAS_CITY_TEST_PUBLIC_SAFETY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function public_safety_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LAS_VEGAS_CITY_TEST_PUBLIC_SAFETY_ENTID");

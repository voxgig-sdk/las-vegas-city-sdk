...
class NewEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LASVEGASCITY_TEST_NEW_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function new_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LASVEGASCITY_TEST_NEW_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LASVEGASCITY_TEST_NEW_ENTID"]);

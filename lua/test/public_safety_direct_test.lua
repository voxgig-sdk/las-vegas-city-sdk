...
describe("PublicSafetyDirect", function()
  it("should direct-load-public_safety", function()
    local setup = public_safety_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-public_safety", setup.live and "live" or "unit")
...
function public_safety_direct_setup(mockres)

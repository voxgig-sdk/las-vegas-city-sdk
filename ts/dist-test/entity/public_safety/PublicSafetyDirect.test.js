...
(0, node_test_1.describe)('PublicSafetyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-public_safety', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public_safety', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LAS_VEGAS_CITY_TEST_PUBLIC_SAFETY_ENTID'];
...
//# sourceMappingURL=PublicSafetyDirect.test.js.map
...
AQL-driven CLI and REPL for the LasVegasCity SDK. Positional arguments are
...
./las-vegas-city-cli list city_info
./las-vegas-city-cli load 1 city_info
./las-vegas-city-cli load '{id:1}' city_info

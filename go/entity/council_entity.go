...
func NewCouncilEntity(client *core.LasVegasCitySDK, entopts map[string]any) *CouncilEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CouncilEntity) GetName() string { return e.name }
...
func (e *CouncilEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CouncilEntity) Deleted() bool {
	return e.deleted
}


func (e *CouncilEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCouncilEntity(e.client, opts)
}

func (e *CouncilEntity) Data(args ...any) any {
...
func (e *CouncilEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CouncilEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CouncilEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *CouncilEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CouncilEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CouncilEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CouncilEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

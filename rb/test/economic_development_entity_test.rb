...
class EconomicDevelopmentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LASVEGASCITY_TEST_ECONOMIC_DEVELOPMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def economic_development_basic_setup(extra)
  ...
  entid_env_raw = ENV["LASVEGASCITY_TEST_ECONOMIC_DEVELOPMENT_ENTID"]

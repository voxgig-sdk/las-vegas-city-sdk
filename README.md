...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/las-vegas-city` | `npm install @voxgig-sdk/las-vegas-city` |
| Python | `voxgig-sdk-las-vegas-city` | `pip install voxgig-sdk-las-vegas-city` |
| PHP | `voxgig-sdk/las-vegas-city` | `composer require voxgig-sdk/las-vegas-city` |
| Golang | `github.com/voxgig-sdk/las-vegas-city-sdk/go` | `go get github.com/voxgig-sdk/las-vegas-city-sdk/go` |
| Ruby | `voxgig-sdk-las-vegas-city` | `gem install voxgig-sdk-las-vegas-city` |
| Lua | `voxgig-sdk-las-vegas-city` | `luarocks install voxgig-sdk-las-vegas-city` |

...
(0, node_test_1.describe)('ParkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-park', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-park', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LAS_VEGAS_CITY_TEST_PARK_ENTID'];
...
//# sourceMappingURL=ParkDirect.test.js.map
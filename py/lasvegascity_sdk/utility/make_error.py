...
def make_error_util(ctx, err):
    if ctx is None:
        from lasvegascity_sdk.core.context import LasVegasCityContext
        ctx = LasVegasCityContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, LasVegasCityError):
        errmsg = err.msg
    ...
    sdk_err = LasVegasCityError("", msg, ctx)

...
class DepartmentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LAS_VEGAS_CITY_TEST_DEPARTMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def department_basic_setup(extra)
  ...
  entid_env_raw = ENV["LAS_VEGAS_CITY_TEST_DEPARTMENT_ENTID"]

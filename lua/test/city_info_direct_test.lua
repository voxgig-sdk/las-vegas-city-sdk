...
describe("CityInfoDirect", function()
  it("should direct-load-city_info", function()
    local setup = city_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-city_info", setup.live and "live" or "unit")
...
function city_info_direct_setup(mockres)

...
function runner.env_override(m)
  local live = runner.getenv("LAS_VEGAS_CITY_TEST_LIVE")
  local override = runner.getenv("LAS_VEGAS_CITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LAS_VEGAS_CITY_TEST_EXPLAIN")

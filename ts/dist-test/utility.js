...
function envOverride(m) {
    if ('TRUE' === process.env.LAS_VEGAS_CITY_TEST_LIVE ||
        'TRUE' === process.env.LAS_VEGAS_CITY_TEST_OVERRIDE) {
    ...
    m.LAS_VEGAS_CITY_TEST_EXPLAIN = process.env.LAS_VEGAS_CITY_TEST_EXPLAIN || m.LAS_VEGAS_CITY_TEST_EXPLAIN;
    return m;
}
